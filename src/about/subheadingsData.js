const subheadingsData = {
  ...
  2: [
    ...
    {
      title: "2022 Higher Secondary Education",
      content: (
        <>
          <p>
            Completed my Higher Secondary Education with a focus on Science,
            excelling in subjects like Physics, Mathematics, and Computer
            Science, which laid a strong foundation for my journey into
            technology.
          </p>
        </>
      ),
